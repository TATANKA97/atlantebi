...
import { validateSemanticDraft } from "../../../../../../lib/semantic-layer/service";
...
export async function POST(
  ...
  if (!id.success || !body.success) {
    return semanticSuccessResponse({ error: "invalid_semantic_validate" }, 400);
  }
